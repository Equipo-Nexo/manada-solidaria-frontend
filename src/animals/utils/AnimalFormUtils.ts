import type { AnimalColor, AnimalPostFilter, AnimalPostStatus, AnimalPostType, AnimalSize, AnimalType } from "../app/types/AnimalPost.types";
...
export const ANIMAL_POST_STATUS_LABELS: Record<AnimalPostStatus | AnimalPostType, string | undefined> = {
